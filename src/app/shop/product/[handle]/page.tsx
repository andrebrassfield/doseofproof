...
const productData: Record<string, {
  ...
  "peptide-protocol-database": {
    ...
    testimonials: [
      { quote: "The reconstitution calculator alone saved me hours. Sourcing links saved me from buying bunk products.", author: "Robert P." },
      { quote: "Used BPC-157 and GHK-Cu stacks to support gut mucosal lining. Dosing updates backed by PubMed citations.", author: "Alyssa T." },
    ],
  ...
  "30-day-mold-detox": {
    ...
    benefits: [
      "Daily supplement stack with exact dosing",
