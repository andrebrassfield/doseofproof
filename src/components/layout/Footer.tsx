...
export function Footer() {
  return (
    <footer className="relative border-t-2 border-stone bg-surface pt-16 pb-8 px-6 lg:px-12 mt-24 overflow-hidden">
      {/* Yellow accent rule across the top */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto border-t border-stone pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted">
